...
def cell(config: dict) -> dict:
    ...
    source = [
        ...
        "        _msg.value = ui.warning_html('Please describe your issue before submitting.')\n",
        "        return\n",
        ...
        "    })\n",
        "    if result['ok']:\n",
        "        _msg.value = ui.success_html(f\"Ticket submitted. Reference: {result['data']['ticket_id']}\")\n",
        "        _text.value = ''\n",
        "    else:\n",
        "        _msg.value = ui.error_html(result.get('error', 'Submission failed. Please try again.'))\n",
        ...
        "    _w.VBox([_support_static, _w.HTML('<hr style=\"border-color:#475569;margin:12px 0\">'), _type_dd, _text, _w.HBox([_btn], layout=_w.Layout(margin='6px 0 0')), _msg]),\n",
        "])\n",
